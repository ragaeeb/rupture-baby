...
type PromptOption = { id: string; name: string; content: string; isMaster?: boolean };
...
export const getSelectedPrompt = () => ({ content: selectedPromptContent, id: selectedPromptId });
